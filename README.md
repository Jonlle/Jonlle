...
### 1. Google Maps Measurement Tool
| **Description** | **Screenshot** |
|-----------------|----------------|
| A tool for measuring distances and areas directly on Google Maps. <br>Key features include: <br>- Customizable markers, polygons and circles. <br>- Integration with the Google Maps API. <br>- Responsive UI built with **TailwindCSS**. <br>- Developed using **React**, **TypeScript**, and **Vite** for fast and efficient performance. <br><br>[![Live Demo](https://img.shields.io/badge/Live-Demo-success?style=flat)](https://measuremap.vercel.app/) [![GitHub](https://img.shields.io/badge/GitHub-Repo-181717?style=flat&logo=github)](https://github.com/Jonlle/google-maps-measure-tools) <br><br> **Tech Stack:**<br>![React](https://img.shields.io/badge/React-61DAFB?style=flat&logo=react&logoColor=white) ![TypeScript](https://img.shields.io/badge/TypeScript-007ACC?style=flat&logo=typescript&logoColor=white) ![TailwindCSS](https://img.shields.io/badge/TailwindCSS-06B6D4?style=flat&logo=tailwind-css&logoColor=white) ![Vite](https://img.shields.io/badge/Vite-646CFF?style=flat&logo=vite&logoColor=white) ![Google Maps API](https://img.shields.io/badge/Google_Maps_API-4285F4?style=flat&logo=google-maps&logoColor=white) | <img src="https://github.com/Jonlle/google-maps-measure-tools/blob/main/screenshots/radius_measurement.png"  width="480" height="270" /> |

### 2. Pokémon Favorites App  
| **Description** | **Screenshot** |  
|------------------|----------------|  
| A web application where users can explore and save their favorite Pokémons. Key features include: <br>- Dynamic Pokémon listing with detailed information. <br>- Favorites management using local storage. <br>- Server-side rendering (SSR) and static site generation (SSG) with **Next.js** for fast and SEO-friendly performance. <br>- Responsive UI built with **TailwindCSS** and styled components from **NextUI** for a modern and clean design. <br><br>[![Live Demo](https://img.shields.io/badge/Live-Demo-success?style=flat)](https://next-pokemon-static.vercel.app) [![GitHub](https://img.shields.io/badge/GitHub-Repo-181717?style=flat&logo=github)](https://github.com/Jonlle/next-pokemon-static) <br><br> **Tech Stack:**<br>![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat&logo=next.js&logoColor=white) ![React](https://img.shields.io/badge/React-61DAFB?style=flat&logo=react&logoColor=white) ![TypeScript](https://img.shields.io/badge/TypeScript-007ACC?style=flat&logo=typescript&logoColor=white) ![TailwindCSS](https://img.shields.io/badge/TailwindCSS-06B6D4?style=flat&logo=tailwind-css&logoColor=white) | <img src="https://github.com/Jonlle/next-pokemon-static/blob/main/screenshots/pokemon_details.png" width="560" height="315" /> |
